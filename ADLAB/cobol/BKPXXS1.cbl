      ...
      ***************************************************************** 00000300
      *                                                               * 00000400
      * MODULE NAME = DFH0CALL                                        * 00000500
      *                                                               * 00000600
      * DESCRIPTIVE NAME = File Inquiry/Update for Sample Application * 00000700
      *                                                               * 00000800
      * @BANNER_START                           01                    * 00000900
      * Licensed Materials - Property of IBM                          * 00001000
      *                                                               * 00001100
      * 5655-M15              DFH0CALL                                * 00001200
      *                                                               * 00001300
      * (C) Copyright IBM Corp. 1990, 1992                            * 00001400
      *                                                               * 00001500
      * CICS                                                          * 00001600
      * (Element of CICS Transaction Server                           * 00001700
      * for z/OS, Version 3 Release 1)                                * 00001800
      * @BANNER_END                                                   * 00001900
      *                                                               * 00002000
      * STATUS = 3.3.0                                                * 00002100
      *                                                               * 00002200
      *---------------------------------------------------------------* 00002300
      *                                                               * 00002400
      * CHANGE ACTIVITY :                                             * 00002500
      * $SEG(DFH0CALL),COMP(SAMPLES),PROD(CICS    ):                  * 00002600
      *                                                               * 00002700
      *     PN= REASON REL YYMMDD HDXIII : REMARKS                    * 00002800
      *    $P0= .      320 900320        : Created.                   * 00002900
      *    $P1= M90474 330 910807 HDBWSH : Prologue fixed.            * 00003000
      *    $P2= M91869 330 920204 HDCTRC : INSPECTs removed.          * 00003100
      *                                                               * 00003200
      * DFH0CALL DIVIDED INTO CLIENT AND SERVER FOR BANKING DEMO      * 00003300
      ***************************************************************** 00003400
       IDENTIFICATION DIVISION.                                         00003500
       PROGRAM-ID. BKPXXS1.                                             00003600
      ...
      *                                                                 00005300
       ...
       01  DFHCOMMAREA.                                                 00006500
           05  FILLER.      COPY BKCLINK.                               00006611
