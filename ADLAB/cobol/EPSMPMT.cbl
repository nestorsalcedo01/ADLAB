   CBL NUMPROC(MIG),FLAG(I,W),RENT
      ...
      *
       01 WS-STATIC-DATA.
           03 STATIC-MAXIMUM-PRINCIPLE    PIC 9(9)V99
                                VALUE 500000.
           03 STATIC-MINIMUM-PRINCIPLE    PIC 9(9)V99
                                VALUE 500.
           03 STATIC-ERRORS.
              ...
              05 FILLER                  PIC X(80)
              VALUE 'YEARS INDICATED, BUT YEARS ZERO OR FEWER'.
              05 FILLER                  PIC 99 VALUE 5.
              05 FILLER                  PIC X(80)
              VALUE 'ZERO OR FEWER MONTHS'.
      ...
      *   Loan amount must be below maximum, above minimum.


      *   Number of years and months must be valid


      *   EPSPDATA-QUOTED-INTEREST-RATE cannot be negative
           IF VALIDATION-INDICATOR = 0
