      ...
      ****** RECORDS IN THE FILE ON TO THE NEXT JOB STEP
       FD  TRMTEDIT
           ...
           BLOCK CONTAINS 0 RECORDS
           RECORD CONTAINS 1101 CHARACTERS
           DATA RECORD IS INPATIENT-TREATMENT-EDIT.
       01  INPATIENT-TREATMENT-EDIT PIC X(1101).
       ...
       FD  TRMTERR
           ...
           BLOCK CONTAINS 0 RECORDS
           DATA RECORD IS INPATIENT-TREATMENT-ERR.
       01  INPATIENT-TREATMENT-ERR.
           05  ERR-MSG                     PIC X(40).
      ...
      * COPY TRAILER.
       ...
       01  WS-OUTPUT-REC.
           ...
           05  FILLER                  PIC X(2) VALUE SPACES.
           05  PATIENT-PHRM-PER-DAY-O  PIC $$,$$9.99.
           05  FILLER                  PIC X(2) VALUE SPACES.
      ...
      * COPY WSACCUMS.
       01  COUNTERS-AND-ACCUMULATORS.
           ...
           05 IN-PHARMACY-CHARGE-TMP   PIC S9(5)V99 COMP-3.
           05 TOTAL-CHARGES            PIC S9(5)V99 COMP-3.
           05 PHARM-MEDICATION         PIC S9(5)V99 COMP-3.
      ...
      *     EXEC SQL INCLUDE WARDDATA END-EXEC.
      *     EXEC SQL INCLUDE MEDICATN END-EXEC.
      *     EXEC SQL INCLUDE HOSPBED END-EXEC.
      ...
      ******** non-numeric fields
           IF NOT VALID-BILLABLE-TYPES IN BILLABLE-TREATMENT-IND
              ...
              ERR-MSG IN INPATIENT-TREATMENT-ERR
           ...
           IF PHARMACY-CST IN INPATIENT-TREATMENT-REC NOT NUMERIC
      ...
      ******** Call to VSAM file to read record
           ...
           IF  (PHARMACY-CST IN INPATIENT-TREATMENT-REC > 990
           OR  PHARMACY-CST IN INPATIENT-TREATMENT-REC < .99)
      ...
      ******** Specific requirements for certain procedures
           ...
           IF  ORAL-ADMIN OR INTRAVENOUS-ADMIN OR INJECTION
               IF PHARMACY-CST IN INPATIENT-TREATMENT-REC = ZERO OR
                  ANCILLARY-CHARGE = ZERO
               MOVE "*** INVALID $$ AMOUNTS FOR PROCEDURES" TO
               ERR-MSG IN INPATIENT-TREATMENT-ERR
               MOVE "Y" TO ERROR-FOUND-SW
      ...
      ****** CHECK FOR VALID SUPERVISOR NURSE-ID
       ...
       700-WRITE-TRMTEDIT.
           ...
           COMPUTE PATIENT-PHRM-PER-DAY-O =
               WS-PHARMACY-CHARGES * 1.15.

           WRITE INPATIENT-TREATMENT-EDIT.
           ADD MEDICATION-COST  TO WS-MEDICATION-CHARGES.
           ADD ANCILLARY-CHARGE TO WS-ANCILLARY-CHARGES.
           ADD +1 TO RECORDS-WRITTEN.
           ADD IN-PHARMACY-CHARGE-TMP TO TOTAL-CHARGES.
       700-EXIT.
           EXIT.

       710-WRITE-TRMTERR.
           WRITE INPATIENT-TREATMENT-ERR.
           ADD +1 TO RECORDS-IN-ERROR.
       710-EXIT.
           EXIT.
      ...
      *  Final file-handling edits and trailer record handling
           ...
           MOVE WS-PHARMACY-CHARGES TO IN-PHARMACY-CHARGE-TMP.
           WRITE INPATIENT-TREATMENT-EDIT FROM WS-TRAILER-REC.
