...
000200 PROGRAM-ID. MSTFILUP.
000300 AUTHOR.  SYSTEMS GROUP.
000400 INSTALLATION.   BIG OL MAINFRAME.
000500 DATE-WRITTEN.   JULY 1990.
000600******************************************************************
000700*
000800*   This is for my Aug. 8th D.L. Class
000800*
000900******************************************************************
...
007900     05  OMF-PAY-QTY                     PIC S9(9).
...
032200*    ACCEPT TH-DATE FROM DATE.
           MOVE FUNCTION CURRENT-DATE(1:8) TO TH-DATE.
032200*    ACCEPT WS-DATE-OUT FROM DATE.
           MOVE FUNCTION CURRENT-DATE(1:8) TO WS-DATE-OUT, MF-DATE.
