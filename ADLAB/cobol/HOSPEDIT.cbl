       ...
       FILE-CONTROL.
           SELECT INFILE
           ASSIGN TO "d:\IDzProjectNew\HospProject\dat\hospin.dat"
             ORGANIZATION IS LINE SEQUENTIAL
             ACCESS MODE IS SEQUENTIAL
             FILE STATUS IS IFCODE.

           SELECT RPTFILE
           ASSIGN TO "d:\IDzProjectNew\HospProject\dat\hosprpt.dat"
           ORGANIZATION IS LINE SEQUENTIAL
             ACCESS MODE IS SEQUENTIAL
             FILE STATUS IS RFCODE.

           SELECT OUTFILE
           ASSIGN TO "d:\IDzProjectNew\HospProject\dat\hospout.dat"
           ORGANIZATION IS LINE SEQUENTIAL
             ACCESS MODE IS SEQUENTIAL
             FILE STATUS IS OFCODE.

           SELECT ERRFILE
           ASSIGN TO "d:\IDzProjectNew\HospProject\dat\hosperr.dat"
           ORGANIZATION IS LINE SEQUENTIAL
             ACCESS MODE IS SEQUENTIAL
